...
//       expect(provider.movie, testDetailEntityObject);
...
//       when(mockGetWatchlistStatus.execute(testDetailEntityObject.id))
...
//       await provider.addWatchlist(testDetailEntityObject);
//       // assert
//       verify(mockGetWatchlistStatus.execute(testDetailEntityObject.id));
//       expect(provider.isAddedToWatchlist, true);
