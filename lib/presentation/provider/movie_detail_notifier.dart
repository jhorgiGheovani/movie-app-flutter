...
class MovieDetailNotifier extends ChangeNotifier {
  ...
  late DetailEntity _movie;
  DetailEntity get movie => _movie;
  ...
  Future<void> addWatchlist(DetailEntity movie) async {
    final result = await saveWatchlist.execute(movie, MOVIE_TYPE);
  ...
  Future<void> removeFromWatchlist(DetailEntity movie) async {
    final result = await removeWatchlist.execute(movie, MOVIE_TYPE);
